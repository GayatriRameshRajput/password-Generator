...
class GUI():
    def __init__(self,master):
        ...
        root.config(bg='#BCEE68')
        root.resizable(False, False)

        self.label = Label(text=":Passward Generator:", anchor=N, fg='darkblue', bg='#BCEE68', font='arial 20 bold underline')
        ...
        self.user = Label(text="Enter User Name: ", font='times 15 bold', bg='#BCEE68', fg='darkblue')
        ...
        self.length = Label(text="Enter Password Length: ", font='times 15 bold', bg='#BCEE68', fg='darkblue')
        ...
        self.generated_password = Label(text="Generated Password: ", font='times 15 bold', bg='#BCEE68', fg='darkblue')
        ...
        self.generate = Button(text="Generate Password", bd=3, relief='solid', padx=1, pady=1, font='Verdana", 15 bold', fg='#68228B', bg='#FF8000', command=self.generate_pass)
